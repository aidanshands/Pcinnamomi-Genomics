...
#-------------------------------------------------------------------------------
# Import Data & Prepare Data for DE Analysis
#-------------------------------------------------------------------------------

# Importing Count data 
countData <- as.matrix(read.csv("Avocado_Count_Matrix.csv", 
...
dds <- DESeqDataSetFromMatrix(countData = countData, 
                              colData = colData, ignoreRank = FALSE, 
                              design = ~Time)
...
#write.csv(N_Counts, file = "Avo_Normalized_counts.csv")
...
# 0h vs 16h 
res_0_vs_16 <- results(dds, contrast=c("Time","16h","0h"), alpha = 0.05, lfcThreshold=1)
#write.csv(res_0_vs_16, file = "Avo16h.csv")
summary(res_0_vs_16)

# 0h vs 24h 
res_0_vs_24 <- results(dds, contrast=c("Time","24h","0h"), alpha = 0.05, lfcThreshold=1)
# write.csv(res_0_vs_24, file = "Avo24h.csv")
summary(res_0_vs_24)
